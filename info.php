...
if (!class_exists('ALInfo')) :
	class ALInfo {
		public $settings;
		public $config;
		public $plugname = 'airlift';
		public $brandname = 'AirLift';
		public $badgeinfo = 'albadge';
		public $ip_header_option = 'alipheader';
		public $brand_option = 'bv_whitelabel_infos';
		public $wp_lp_whitelabel_option = 'alLpWhitelabelConf';
		public $version = '6.71';
		public $webpage = 'https://airlift.net';
		public $appurl = 'https://app.airlift.net';
		public $slug = 'airlift/airlift.php';
		public $plug_redirect = 'alredirect';
		public $logo = '../img/airlift-white-logo.svg';
		public $brand_icon = '/img/icon.png';
		public $services_option_name = 'alconfig';
		public $author = 'AirLift';
		public $title = 'AirLift';
		...
		public function hasValidDBVersion() {
			return ALInfo::DB_VERSION === $this->getCurrentDBVersion();
		}
		...
		public function getConnectionKey() {
			...
			$tag = ALRecover::connectionTag($this->settings);
		...
		public static function getRequestID() {
			if (!defined("AL_REQUEST_ID")) {
				define("AL_REQUEST_ID", uniqid(mt_rand())); // phpcs:ignore WordPress.WP.AlternativeFunctions.rand_mt_rand
			}
			return AL_REQUEST_ID;
		}
